...
describe('#getLatest', () => {
  test('could get latest', async () => {
    ...
    expect(result1).toStrictEqual({
      ...
      bookValue: null,
      bookValueYearlyIncrease: null,
      bookValueYearlyDecrease: null,
      ebitdaYearlyIncrease: null,
      ebitdaYearlyDecrease: null,
      epsYearlyIncrease: null,
      epsYearlyDecrease: null,
      equityYearlyIncrease: null,
      equityYearlyDecrease: null,
      freeCashFlowYearlyIncrease: null,
      freeCashFlowYearlyDecrease: null,
      peRatio: null,
      peYearlyIncrease: null,
      peYearlyDecrease: null,
      pbRatio: null,
      pbYearlyIncrease: null,
      pbYearlyDecrease: null,
      psRatio: null,
      psYearlyIncrease: null,
      psYearlyDecrease: null,
    })
